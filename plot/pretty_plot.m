...
u32 = [2.365,2.052,1.721,1.386,1.109,0.964,0.885,0.844,0.814,0.797];

figure
hold on
s = 'sgolay';
plot(radius/10,smooth(u22,s),'--','color',[0.80 0.36 0.27])
plot(radius/10,smooth(u32,s),'k')
...
set(gca, 'XScale','log','YScale','linear')
legend('Combined 2000 K','Combined 1500 K', 'Combined 1000 K', 'van der Waals 2000 K')
xlabel('Bubble radius [nm]')
ylabel('b x10^{25}')
xlim([.3 1e3])
...
radius = [5,11,23,50,108,232,500,1077,2321,5000];
boxsize = [50,108,232,500,1077,2321,5000,10772,23208,50000];
eV50 = [2.771,2.656,2.4414,2.0832,1.6947,1.4797,1.3504,1.2936,1.2456,1.215];
eV150 = [2.6783,2.4872,2.1854,1.7954,1.4389,1.2517,1.1423,1.0904,1.0501,1.0267];
eV300 = [2.3651,2.0519,1.7212,1.3858,1.1094,0.96428,0.88479,0.84417,0.81426,0.79706];
eV600 = [1.2113,1.0864,0.94554,0.7924,0.66107,0.58628,0.54231,0.51926,0.50495,0.49415];
eV1000 = [0.73146,0.665,0.59989,0.51729,0.44392,0.39807,0.37048,0.35748,0.34942,0.34234];
